...
namespace Requirement_Management.ViewModels
{
    ...
    public class RequirementReportView
    {
        public RequirementReportView()
        {
            From = DateTime.Today;
            To = DateTime.Today;
            ReqReport = new List<RequirementStatusReportView>();
        }
        ...
        public List<RequirementStatusReportView> ReqReport { get; set; }
    }

    public class RequirementStatusReportView
    {
        public int Id { get; set; }
